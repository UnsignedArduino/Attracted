...
function showMenu(){
  ...
  WH2.resize(gap/3, gap/3);
  image(WH2, gap*1.3, height-100)
  pop()
  push()
  smallBH2.resize(gap/3, gap/3);
  image(smallBH2, gap*2.3, height-100)

  bigBH2.resize(gap/3, gap/3);
  image(bigBH2, gap*3.3, height-100)
  pop()
